...
class VMtranslator:
    def __init__(self, file_path):
        ...
        self.arithmetic_table={"add":"+","sub":"-","neg":"-","and":"&","or":"|","not":"!"}
...
class VMTranslator:
    ...
    def parse(self):
        ...
        for code in self.codes:
            ...
            if len(part)==1 and part[0]!="return": # arithmetic commands
                ...
                self.asm_code+=self.C_return(part[0])
    ...
    def C_return(self,command):
        ...
        asm_code+=["@R13","D=M","A=M-1","A=M","D=M","@THAT","M=D"]
        
        #restores THIS
        asm_code+=["@R2","D=A","@R13","A=M-D","D=M","@THIS","M=D"]
        
        #restores ARG
        asm_code+=["@R3","D=A","@R13","A=M-D","D=M","@THIS","M=D"]
        
        #restores LCL
        asm_code+=["@R4","D=A","@R13","A=M-D","D=M","@THIS","M=D"]
